...
module.exports = {
    ...
    async fetchinfo(id) {
        ...
        if (response && response.servers) {
            ...
            return [hostnames, players, maxplayers, gamemap, gametype, ip, gameparser, gamename];
        } else {
            return false;
        }
    },
    ...
    getinfo(gamever, ip, type) {
        ...
        switch (gamever) {
            ...
            case "Call of Duty Multiplayer - Ship COD_T6_S MP build 1.0.44 CL(1759941) CODPCAB2 CEG Fri May 9 19:19:19 2014 win-x86 813e66d5":
                ...
                if (type == 'zstandard' || type == 'zclassic') dc = "plutonium://play/t6zm/" + ip;
                else dc = "plutonium://play/t6mp/" + ip;
                break;
